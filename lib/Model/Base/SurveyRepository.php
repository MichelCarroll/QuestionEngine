...
/**
 * Base class of repository of Model\Survey document.
 */
abstract class SurveyRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Survey';
        $this->isFile = false;
        $this->collectionName = 'model_survey';
