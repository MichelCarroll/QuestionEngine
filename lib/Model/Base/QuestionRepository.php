...
/**
 * Base class of repository of Model\Question document.
 */
abstract class QuestionRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Question';
        $this->isFile = false;
        $this->collectionName = 'model_question';
